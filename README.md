...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create point-of-interest-64d5
  fly apps create point-of-interest-64d5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app point-of-interest-64d5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app point-of-interest-64d5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'point-of-interest-64d5-staging' does not match app name in config file 'point-of-interest-64d5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name point-of-interest-64d5-db
  fly postgres attach --app point-of-interest-64d5 point-of-interest-64d5-db

  fly postgres create --name point-of-interest-64d5-staging-db
  fly postgres attach --app point-of-interest-64d5-staging point-of-interest-64d5-staging-db
  ```
